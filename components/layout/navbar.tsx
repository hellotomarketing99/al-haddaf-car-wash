      ...
      <div className="container-premium flex items-center justify-between">
        ...
        <nav className="hidden lg:flex items-center gap-8">
          ...
          <div className="relative group">
            <button className="flex items-center gap-1 text-sm font-medium text-muted-foreground transition-colors group-hover:text-primary py-2">
        ...
        <div className="hidden lg:flex items-center gap-4">
          <Link href={`tel:${siteConfig.phone}`} className="flex items-center gap-2 text-sm font-bold text-primary">
            <Phone size={16} />
            {siteConfig.phone}
          </Link>
          <Link href="/book">
